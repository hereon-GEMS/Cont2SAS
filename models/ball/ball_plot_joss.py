...
for i,t in enumerate(t_arr):
    ...
    for j in range(n_ensem):
        ...
        if idx_ensem==0:
            ...
            cbar.set_label(cbar_label, labelpad=10, fontsize=13.5)
            cbar.ax.tick_params(width=1.5, labelsize=13.5)
            ## plot title
    ...
    ## labels
    ax.set_xlabel(r'Q [$\mathrm{\AA}^{-1}$]', fontsize=13.5)
    ax.set_ylabel(r'I(Q) [$\mathrm{cm}^{-1}$]', fontsize=13.5)
    ## ticksize
    ax.tick_params(axis="both", labelsize=13.5)
